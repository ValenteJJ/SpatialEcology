...
First, note that the standard is to calculate K for values of r out to 1/4 of the length of the shortest side in the window. Beyond this, it's been shown that statistical properties of K become wonky.
