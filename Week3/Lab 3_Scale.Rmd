...
*What is the maximum radius you could evaluate? Why?*

Ok, so there we have it. We know know what proportion of the area around each point is comprised of forest at two scales. Let's package this into a neat li
```{r}
